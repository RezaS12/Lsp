...
class GuruController extends Controller
{
    ...
    public function index()
    {
        return view('guru.index', [
            'guru' => Guru::all() //menampilkan data guru
        ]);
    }
    ...
    {
        // validate adalah proses pengecekan data yang masuk
        $data_guru = $request->validate([ //jika aturan validasi lolos, kode anda akan tetap dijalankan secara normal
